...
# 志愿服务 - 硬编码正确题目
zhiyuan_questions = [
    {"q": "中国青年志愿者协会成立于（）", "opts": ["1994年12月5日", "1995年11月5日", "2000年12月5日", "2003年11月5日"], "ans": 0, "type": "choice"},
    {"q": "在香港志愿者被称为（）", "opts": ["志愿者", "义工", "志工", "义务工作者"], "ans": 1, "type": "choice"},
    {"q": "中国青年志愿者协会英文名（）", "opts": ["Chinese Young Volunteers organization", "chinese youth volunteers Associasion", "Chinese Young Volunteers Associasion", "chinese youth volunteers Party"], "ans": 2, "type": "choice"},
    {"q": "青年志愿者协会的会歌是（）", "opts": ["青年志愿者之歌", "奉献", "爱心", "我相信"], "ans": 0, "type": "choice"},
    {"q": "国际志愿者日时间（）", "opts": ["11月6日", "12月15日", "12月5日", "1月25日"], "ans": 2, "type": "choice"},
    {"q": "中国青年志愿者服务日（）", "opts": ["3月8日", "3月5日", "4月15日", "5月5日"], "ans": 1, "type": "choice"},
    {"q": "1963年3月5日（）发出了向雷锋同志学习的号召，以后这一天被定为学雷锋纪念日。", "opts": ["邓小平", "周恩来", "朱德", "毛泽东"], "ans": 3, "type": "choice"},
    {"q": "下列哪些不是志愿服务特征（）", "opts": ["公益性", "自愿性", "强制性", "无偿性"], "ans": 2, "type": "choice"},
    {"q": "广大青年志愿者奉献给社会的不仅仅是服务，同时也向全社会昭示了一种精神，那就是（）的青年志愿者精神。", "opts": ["进取积极互助友爱", "奉献友爱互助进步", "积极互助奉献友爱", "互助奉献友爱进取"], "ans": 1, "type": "choice"},
    {"q": "1985年第（）届联大确定每年12月5日为国际志愿人员日。", "opts": ["30", "33", "40", "41"], "ans": 2, "type": "choice"},
    {"q": "（）由共青团中央等单位发起的中国青年志愿者协会在北京成立。", "opts": ["1992年12月5日", "1994年12月5日", "1996年12月5日", "1998年12月5日"], "ans": 1, "type": "choice"},
    {"q": "中国青年志愿者协会在（）成立", "opts": ["上海", "深圳", "北京", "南京"], "ans": 2, "type": "choice"},
    {"q": "中国青年志愿者标志表达（）的志愿者主题。", "opts": ["热情献社会真情暖人心", "真情献社会爱心暖人心", "关爱献社会真情护人心", "真情献社会关爱护人心"], "ans": 0, "type": "choice"},
    {"q": "中国青年志愿者协会的缩写是（）", "opts": ["CYVA", "CNVA", "CNVB", "CYVB"], "ans": 0, "type": "choice"},
    {"q": "（）是国际志愿者年", "opts": ["1999年", "2000年", "2001年", "2002年"], "ans": 2, "type": "choice"},
    {"q": "我国的社区志愿服务首创于（）市", "opts": ["广州", "北京", "天津", "上海"], "ans": 2, "type": "choice"},
    {"q": "1999年8月以（）通过国内第一部青年志愿者服务条例。", "opts": ["广东人大", "天津人大", "上海人大", "北京人大"], "ans": 0, "type": "choice"},
    {"q": "每年的3月12日是什么节日（）", "opts": ["世界地球日", "中国植树节", "艾滋病日", "感恩节"], "ans": 1, "type": "choice"},
    {"q": "世界环境日是每年的（）", "opts": ["4月5日", "5月5日", "6月5日", "7月5日"], "ans": 2, "type": "choice"},
    {"q": "志愿者是指那些具有（）能够主动承担社会责任而不关心报酬的人。", "opts": ["奉献精神", "志愿精神", "牺牲精神", "大爱精神"], "ans": 0, "type": "choice"},
    {"q": "志愿服务是指任何人志愿贡献个人的（）在不为任何物质报酬的情况下为改善社会服务而提供的服务。", "opts": ["时间", "金钱", "精力", "时间与精力"], "ans": 3, "type": "choice"},
    {"q": "志愿组织是志愿者通过登记注册或者自发成立的（）组织开展服务活动。", "opts": ["合作社团", "盈利社团", "服务社团", "奉献社团"], "ans": 2, "type": "choice"},
    {"q": "（）就是不求回报乐于服务的精神。", "opts": ["志愿精神", "奉献精神", "牺牲精神", "大爱精神"], "ans": 1, "type": "choice"},
    {"q": "（）表示志愿精神广泛普及，参与志愿服务的公民普遍化。", "opts": ["志愿社会", "友爱社会", "和谐社会", "互助社会"], "ans": 3, "type": "choice"},
    {"q": "哪个特性不属于志愿服务（）", "opts": ["自愿性", "非报酬性", "业余性", "组织性"], "ans": 2, "type": "choice"},
    {"q": "全国第一条志愿服务热线诞生于哪个城市（）", "opts": ["广州", "上海", "深圳", "北京"], "ans": 0, "type": "choice"},
    {"q": "1999年8月5日（）省颁布了大陆第一部关于志愿服务的地方性法规。", "opts": ["广东", "天津", "上海", "北京"], "ans": 0, "type": "choice"},
    {"q": "（）的技巧是指在具体组织志愿服务活动时要善于改变传统思维。", "opts": ["凸显创意", "多出花样", "职责分担", "话语激励"], "ans": 3, "type": "choice"},
    {"q": "现代志愿服务是诞生于19世纪的（）国家。", "opts": ["非洲", "亚洲", "欧美", "南半球"], "ans": 2, "type": "choice"},
    {"q": "欧美及各国的志愿服务形成了（）格局。", "opts": ["一三二", "二三一", "三二一", "一二三"], "ans": 0, "type": "choice"},
    {"q": "欧美及各国志愿服务最初的主要力量来自（）", "opts": ["政府", "民间", "个人", "企业"], "ans": 1, "type": "choice"},
    {"q": "关于注册志愿者下面说法错误的（）", "opts": ["每名至少参加一个项目", "每年累计不少于20小时", "无论任何活动都要参加", "自觉维护志愿者形象"], "ans": 2, "type": "choice"},
    {"q": "记录志愿服务信息的办法由国务院（）会同有关单位制定。", "opts": ["民政部门", "教育部", "财政部", "商务部"], "ans": 0, "type": "choice"},
    {"q": "2001年国际志愿者协会在荷兰阿姆斯特丹通过了（）两个文件。", "opts": ["全球志愿者公告全球行动指南", "全球志愿者公告全球志愿者方案", "全球志愿者宣言全球行动指南", "全球志愿者宣言全球行动方案"], "ans": 3, "type": "choice"},
    {"q": "开展志愿服务应当遵循（）的原则。", "opts": ["文明无偿平等诚信合法", "自觉无偿平等诚信合法", "自愿无偿平等诚信合法", "自觉无偿平等诚信守法"], "ans": 2, "type": "choice"},
    {"q": "在志愿服务组织中根据（）的规定设立中国共产党的组织。", "opts": ["宪法", "民法", "中国共产党章程", "刑法"], "ans": 2, "type": "choice"},
    {"q": "下面哪种不属于志愿者心理自我调适的方法（）", "opts": ["重新认识志愿服务的价值", "渲泄转移", "改善人际关系", "向服务对象发泄"], "ans": 3, "type": "choice"},
    {"q": "联合国志愿人员组织成立于（）", "opts": ["1971", "1974", "1973", "1970"], "ans": 3, "type": "choice"},
]
qs = zhiyuan_questions
if qs:
